...
-- Existing driver-mobile UI captures delivery and damage photos separately, but
-- the historical jobs schema had no dedicated persistence field. Keep the same
-- JSONB evidence representation used by delivery_photos and pod_photos.
