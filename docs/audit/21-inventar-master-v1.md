...
| IM-EV-02 | `/home/runner/work/xdrivelogistics.co.uk/xdrivelogistics.co.uk/app/robots.ts:7-13` | Indexare | public + private pages | crawler rules | excludere dashboard-uri private | `allow: '/'` global | CRITICAL | risc SEO/indexare accidentală suprafețe private | adaugă `disallow` explicit pentru suprafețe autentificate | ❌ |
