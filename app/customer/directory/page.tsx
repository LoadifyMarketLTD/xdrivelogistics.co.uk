...
export default function CustomerDirectoryPage() {
  return (
    <PageFrame>
      <PageHeader eyebrow="XDrive member network" title="Directory" description="Search XDrive companies and drivers independently of your own Companies relationship register." />
