...
- Name: public.spec.ts >> Public pages >> login page loads
- Location: e2e/public.spec.ts:24:3

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at http://127.0.0.1:3000/login
Call log:
