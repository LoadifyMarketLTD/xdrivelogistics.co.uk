-- Backfill for already-migrated preview/staging environments.
-- Re-applies the hardened fraud decision atomicity function without rewriting prior migrations.
