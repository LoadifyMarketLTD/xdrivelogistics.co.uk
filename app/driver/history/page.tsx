  ...
  const filterRail = (
    <aside className="left diary-filter-rail" aria-label="Diary search filters">
      ...
      <div className="diary-filter-body">
        <fieldset className="filter driver-diary-scope"><legend className="label">Booking Scope</legend><label><input type="radio" name="diary-scope" checked readOnly /> All assigned bookings</label><label title="Company-level subcontracted jobs are not part of the Driver workspace."><input type="radio" name="diary-scope" disabled /> Jobs Sub-contracted</label><label title="Company-level own bookings are not part of the Driver workspace."><input type="radio" name="diary-scope" disabled /> Our Bookings</label></fieldset>
                            ...
                            {detailTab === 'order' && (orderLoading ? <EmptyState compact title="Loading Order confirmation…" /> : (
                              <>
                                ...
                                <div className="driver-detail-grid">
                                  ...
                                  <div className="driver-detail-item"><span>Body type</span><strong>{sheet?.allocatedVehicle.bodyType ? human(sheet.allocatedVehicle.bodyType) : 'Not supplied'}</strong>{!sheet?.allocatedVehicle.bodyType && <small>{sheet?.unavailable.bodyType ?? 'Not available for this booking.'}</small>}</div>
                                  ...
                                  <div className="driver-detail-item"><span>Hard-copy POD</span><strong>{sheet?.hardCopyPod ?? job.hard_copy_pod ?? (job.pod_required == null ? 'Requirement not supplied' : job.pod_required ? 'Required' : 'Not required')}</strong></div>
