...
revoke execute on function public.accept_driver_invite(text, text, text) from public, anon;
grant execute on function public.accept_driver_invite(text, text, text) to authenticated, service_role;
