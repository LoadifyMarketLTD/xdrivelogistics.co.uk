...
CREATE OR REPLACE FUNCTION pg_temp.assert_count(p_actual bigint, p_expected bigint, p_message text)
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
...
INSERT INTO public.notification_events (
  id, event_type, entity_type, entity_id, company_id, recipient_user_id, payload, status
)
VALUES
