-- Canonical driver execution lifecycle used by web, native Android and operator APIs.
-- Apply on staging first and run the full allocated -> completed workflow before production.
