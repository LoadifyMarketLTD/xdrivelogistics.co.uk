...
- Name: public.spec.ts >> Auth redirects >> unauthenticated /admin redirects to login
- Location: e2e/public.spec.ts:33:3

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at http://127.0.0.1:3000/admin
Call log:
