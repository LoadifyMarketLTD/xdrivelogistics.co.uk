 ...
 * can prove the map container is bounded without live Supabase credentials.
...
const WITH_COORDS_POINTS: FleetMapPoint[] = [
  ...
  {
    driverId: 'driver-fx-3',
    driverName: 'Carol Driver',
    lat: 53.8,
    lng: -1.55,
    jobId: null,
    timestamp: null,
...
const INVALID_COORDS_POINTS: FleetMapPoint[] = [
  {
    driverId: 'driver-invalid-1',
    driverName: 'Invalid Latitude',
    lat: 999,
    lng: -0.12,
    jobId: null,
    timestamp: null,
  ...
  {
    driverId: 'driver-invalid-2',
    driverName: 'Invalid Longitude',
    lat: 51.5,
    lng: 999,
    jobId: null,
    timestamp: null,
...
const SCENARIOS: Record<string, { points: FleetMapPoint[]; selectedDriverId: string | null }> = {
  ...
  'provider-error': { points: WITH_COORDS_POINTS, selectedDriverId: 'driver-fx-1' },
  'no-coords': { points: [], selectedDriverId: null },
  'invalid-coords': { points: INVALID_COORDS_POINTS, selectedDriverId: null },
};
