...
- Name: public.spec.ts >> Auth redirects >> unauthenticated /driver/jobs redirects to login
- Location: e2e/public.spec.ts:40:3

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at http://127.0.0.1:3000/driver/jobs
Call log:
  - navigating to "http://127.0.0.1:3000/driver/jobs", waiting until "load"
