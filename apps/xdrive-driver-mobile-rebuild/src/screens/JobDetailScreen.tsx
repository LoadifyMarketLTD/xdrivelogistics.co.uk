    ...
    <ScrollView contentContainerStyle={styles.content}>
      {tab === 'summary' ? <View style={styles.card}>
        ...
        {job.contactName || job.contactPhone ? <View style={styles.contactRow}>
          ...
          {job.contactPhone ? <Pressable onPress={() => Linking.openURL(`tel:${job.contactPhone}`)} style={styles.contactButton}><Ionicons name="call" size={19} color={colors.black} /></Pressable> : null}
        </View> : null}
      ...
      {tab === 'status' ? <View style={styles.card}>
        ...
        <DeliveryTimeline status={job.status} />
...
const styles = StyleSheet.create({
  ...
  contactName: { flex: 1, fontFamily: 'Inter_600SemiBold', fontSize: 13, color: colors.text },
  ...
  noteValue: { marginTop: 3, fontFamily: 'Inter_400Regular', fontSize: 11, lineHeight: 16, color: colors.muted },
  ...
  stopTime: { marginTop: 3, fontFamily: 'Inter_400Regular', fontSize: 11, color: colors.muted },
  stopAddress: { marginTop: 5, fontFamily: 'Inter_600SemiBold', fontSize: 12, color: colors.text },
