...
export default async function SuperAdminDashboardRootPage() {
  // Inițializăm instanța securizată folosind direct cheia de admin din Netlify (Bypass complet de căi lipsă)
  const supabase = createClient(
    process.env.NEXT_PUBLIC_SUPABASE_URL!,
    process.env.SUPABASE_SERVICE_ROLE_KEY!
  );

  // Executăm interogările globale în paralel pentru performanță maximă
