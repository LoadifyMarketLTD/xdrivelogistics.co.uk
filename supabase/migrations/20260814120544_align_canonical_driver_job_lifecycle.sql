-- Re-apply the canonical driver execution RPC after later runtime migrations
-- replaced it with a reduced lifecycle that skipped the in_transit step and
-- omitted the full POD evidence checks.
