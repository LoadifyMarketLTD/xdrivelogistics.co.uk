              ...
              {companies.map((co) => (
                <tr key={co.id} style={{ borderBottom: `1px solid ${THEME.cardBorder}` }}>
                  <td style={{ padding: '0.75rem 0.9rem', color: THEME.text, fontWeight: 600 }}>
                    {co.name}
                    <span style={{ marginLeft: '0.4rem', fontSize: '0.66rem', color: THEME.red, backgroundColor: '#fef2f2', border: `1px solid ${THEME.red}`, borderRadius: '4px', padding: '0.1rem 0.35rem', fontWeight: 700, textTransform: 'uppercase' }}>
                      Suspended
                    </span>
                  </td>
