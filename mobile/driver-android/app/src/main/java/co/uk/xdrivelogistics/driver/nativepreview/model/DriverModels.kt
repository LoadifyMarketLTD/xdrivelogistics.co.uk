...
data class NativeAlert(val id:String,val title:String,val body:String,val type:String,val createdAt:String?,val unread:Boolean,val entityType:String?=null,val entityId:String?=null,val status:String?=null,val payloadJson:String="{}",val saved:Boolean=false,val deleted:Boolean=false,val actionable:Boolean=false)
