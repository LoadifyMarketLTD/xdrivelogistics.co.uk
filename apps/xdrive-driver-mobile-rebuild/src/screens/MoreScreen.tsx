...
const styles = StyleSheet.create({
  ...
  content: { padding: spacing.lg, paddingBottom: 30, gap: 11 },
  ...
  avatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: colors.iconWell, alignItems: 'center', justifyContent: 'center' },
  ...
  menuRow: { minHeight: 70, backgroundColor: colors.surface, borderRadius: radius.medium, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', gap: 12 },
  ...
  menuValue: { marginTop: 3, fontFamily: 'Inter_400Regular', fontSize: 11, color: colors.muted },
