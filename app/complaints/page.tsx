...
<Link href="/" className="text-sm font-black text-[#F5A300]">← Back to XDrive</Link><p className="mt-10 text-xs font-black uppercase tracking-[0.18em] text-[#F5A300]">Support & Resolution</p><h1 className="mt-3 text-4xl font-black sm:text-5xl">Complaints & Disputes</h1><p className="mt-3 text-sm font-semibold text-white/55">Last updated: {LAST_UPDATED}</p>
...
</div><div className="mt-12 flex flex-wrap gap-4 border-t border-white/10 pt-7 text-sm font-black text-[#F5A300]"><Link href="/terms">Terms</Link><Link href="/subscription-terms">Subscription Terms</Link><Link href="/privacy">Privacy</Link><Link href="/contact">Contact</Link></div>
</div></main>}
