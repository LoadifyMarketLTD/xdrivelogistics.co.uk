...
-- No-op body: this file is superseded by 20260801160500_safe_company_governance_audit_enrichment.sql.
-- Executable SQL has been removed to prevent accidental execution during supabase db push.
DO $$
BEGIN
  RAISE NOTICE 'Migration 20260801153000 superseded; no changes applied.';
END
$$;
