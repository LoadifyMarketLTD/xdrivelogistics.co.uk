...
- Name: public.spec.ts >> Public pages >> homepage has navigation links
- Location: e2e/public.spec.ts:14:3

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at http://127.0.0.1:3000/
Call log:
