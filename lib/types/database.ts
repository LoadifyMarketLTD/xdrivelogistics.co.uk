...
export interface Invoice {
  ...
  issuer_company_number_snapshot?: string | null;
  issuer_vat_number_snapshot?: string | null;
  issuer_xd_id_snapshot?: string | null;
  issuer_email_snapshot?: string | null;
  issuer_phone_snapshot?: string | null;
  customer_company_number_snapshot?: string | null;
  customer_vat_number_snapshot?: string | null;
  customer_xd_id_snapshot?: string | null;
