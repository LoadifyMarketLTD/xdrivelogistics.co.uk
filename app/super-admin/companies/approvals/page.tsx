      ...
      <div style={{ backgroundColor: THEME.cardBg, border: `1px solid ${THEME.cardBorder}`, borderRadius: '4px', overflow: 'hidden' }}>
        {loading ? (
          ...
          <div style={{ padding: '2rem', textAlign: 'center', color: THEME.muted, fontSize: '0.88rem' }}>
            ...
            Companies with status <code style={{ backgroundColor: THEME.cardBg, padding: '0.1rem 0.3rem', borderRadius: '4px' }}>pending</code> (legacy: <code style={{ backgroundColor: THEME.cardBg, padding: '0.1rem 0.3rem', borderRadius: '4px' }}>pending_approval</code>) will appear here.
            </span>
          </div>
        ) : (
