...
export const resolveWorkspaceRole = (
  user: WorkspaceUserLike | null | undefined
): WorkspaceRole => {
  ...
  if (
    ...
    ['owner_driver', 'owner_operator', 'self_employed', 'self_employed_driver', 'sole_trader'].includes(
      rawRole
    )
  ) {
    return 'owner_driver';
...
const CAPABILITIES: Record<WorkspaceRole, ReadonlySet<WorkspaceCapability>> = {
  ...
  driver: new Set<WorkspaceCapability>([
    'jobs.view',
    'jobs.execute',
    'jobs.track',
    'documents.own.manage',
...
const carrierNav: WorkspaceNavGroup[] = [
  {
    id: 'home',
    label: 'Workspace',
    items: [{ id: 'dashboard', label: 'Carrier Dashboard', href: '/admin', icon: '⌂' }],
  },
  {
    id: 'commercial',
    label: 'Commercial',
  ...
  },
  {
    id: 'finance',
    label: 'Finance',
    items: [{ id: 'invoices', label: 'Invoices', href: '/admin/invoices', icon: '£', capability: 'invoices.carrier.manage' }],
  },
  {
    id: 'administration',
...
export const WORKSPACE_DEFINITIONS: Record<WorkspaceRole, WorkspaceDefinition> = {
  ...
  company_owner: {
    role: 'company_owner',
    label: 'Company Owner',
    subtitle: 'Company commercial and operational control',
    homeHref: '/admin',
    primaryAction: { label: 'Find Loads', href: '/admin/marketplace', capability: 'loads.view.marketplace' },
    nav: carrierNav,
  },
  company_admin: {
    role: 'company_admin',
    label: 'Company Admin',
    subtitle: 'Company operations and administration',
    homeHref: '/admin',
    primaryAction: { label: 'Find Loads', href: '/admin/marketplace', capability: 'loads.view.marketplace' },
    nav: carrierNav,
  },
  carrier_admin: {
    role: 'carrier_admin',
    label: 'Carrier Workspace',
    subtitle: 'Commercial, operations and fleet',
    homeHref: '/admin',
    primaryAction: { label: 'Find Loads', href: '/admin/marketplace', capability: 'loads.view.marketplace' },
    nav: carrierNav,
  },
  broker: {
    ...
    subtitle: 'Customer loads, carrier sourcing and margin control',
    homeHref: '/broker',
    primaryAction: { label: 'Post Load', href: '/broker/post-load', capability: 'loads.create' },
    nav: [
  ...
  customer: {
    ...
    subtitle: 'Post, award and track your transport',
    homeHref: '/customer',
    primaryAction: { label: 'Post Load', href: '/customer/post-load', capability: 'loads.create' },
    nav: [
  ...
  fleet_manager: {
    ...
    subtitle: 'Capacity, assignments, compliance and live operations',
    homeHref: '/admin/fleet',
    nav: [
  ...
  dispatcher: {
    ...
    subtitle: 'Allocate, monitor and recover daily jobs',
    homeHref: '/admin/operations-centre',
    nav: [
  ...
  driver: {
    ...
    subtitle: 'Today, assigned work and proof of delivery',
    homeHref: '/driver',
    nav: [
  ...
  owner_driver: {
    role: 'owner_driver',
    label: 'Owner Driver Workspace',
    subtitle: 'Find work, execute jobs and manage your business',
    homeHref: '/driver',
    primaryAction: { label: 'Find Loads', href: '/driver/loads', capability: 'loads.view.marketplace' },
    nav: [
  ...
  compliance: {
    ...
    subtitle: 'Verification, expiry and operational readiness',
  ...
  viewer: {
    ...
    subtitle: 'Approved operational visibility',
    homeHref: '/admin',
...
export const getWorkspaceDefinition = (role: WorkspaceRole): WorkspaceDefinition =>
  WORKSPACE_DEFINITIONS[role];
...
export const getWorkspaceHomeRoute = (
  user: WorkspaceUserLike | null | undefined
): string => WORKSPACE_DEFINITIONS[resolveWorkspaceRole(user)].homeHref;
