...
CREATE INDEX IF NOT EXISTS idx_invoices_company_created_by_created
  ON public.invoices (company_id, created_by, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_invoices_company_client_email_created
  ON public.invoices (company_id, client_email, created_at DESC);
